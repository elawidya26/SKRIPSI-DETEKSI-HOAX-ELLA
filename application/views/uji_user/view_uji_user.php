									...
									<div class="col-lg-12">
										...
										<div class="card card-custom gutter-b example example-compact">
											<div class="card-header">
												<h3 class="card-title">Uji Postingan pada Media Sosial</h3>
											...
											<form class="form">
												<div class="card-body">
                                                    ...
                                                    <div class="form-group">
														<label>Judul:</label>
														<input type="email" class="form-control form-control-solid" placeholder="Masukan judul" />
														<span class="form-text text-muted">Silahkan masukkan judul laporan</span>
													</div>
													<div class="form-group">
														<label>Isi Laporan :</label>
														<input type="email" class="form-control form-control-solid" placeholder="Masukan isi laporan" />
														<span class="form-text text-muted">Silahkan masukkan isi laporan dari media sosial</span>
													</div>
                                                    <div class="form-group">
														<label>Bukti :</label>
														<input type="email" class="form-control form-control-solid" placeholder="Masukan bukti " />
                                                    ...
                                                    <div class="form-group">
														...
														<div class="checkbox-list">
															...
															<input type="checkbox" />
															<span></span>Twitter</label>
															<label class="checkbox">
															<input type="checkbox" />
															<span></span>Facebook</label>
                                                            <label class="checkbox">
															<input type="checkbox" />
