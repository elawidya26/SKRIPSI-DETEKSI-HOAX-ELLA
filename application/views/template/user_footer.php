					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">Deteksi Hoax Twitter</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
							<div class="nav nav-dark order-1 order-md-2">
								<a href="" target="_blank" class="nav-link pr-3 pl-0">Tentang Penelitian</a>
								<a href="" target="_blank" class="nav-link px-3">FAQ</a>
							</div>
							<!--end::Nav-->
						</div>
						<!--end::Container-->
		...
		<div id="kt_scrolltop" class="scrolltop">
			<span class="svg-icon">
				<!--begin::Svg Icon | path:<?php echo base_url() ?>assets/frontend/media/svg/icons/Navigation/Up-2.svg-->
		...
		<script src="<?php echo base_url() ?>assets/frontend/plugins/global/plugins.bundle.js?v=7.2.9"></script>
