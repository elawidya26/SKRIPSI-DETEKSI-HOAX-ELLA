...
<html lang="en">
	...
	<head>
		...
		<link href="<?php echo base_url() ?>assets/frontend/plugins/global/plugins.bundle.css?v=7.2.9" rel="stylesheet" type="text/css" />
		<link href="<?php echo base_url() ?>assets/frontend/plugins/custom/prismjs/prismjs.bundle.css?v=7.2.9" rel="stylesheet" type="text/css" />
		<link href="<?php echo base_url() ?>assets/frontend/css/style.bundle.css?v=7.2.9" rel="stylesheet" type="text/css" />
		...
		<div id="kt_header_mobile" class="header-mobile header-mobile-fixed">
				...
				<div class="header-switcher dropdown mr-2">
					<a href="#" class="btn btn-icon border-0" data-toggle="dropdown" data-offset="0px,1px" aria-haspopup="true" aria-expanded="false">
						<span class="svg-icon svg-icon-xl">
							<!--begin::Svg Icon | path:<?php echo base_url() ?>assets/frontend/media/svg/icons/Shopping/Box2.svg-->
			...
			<div class="d-flex align-items-center">
				...
				<button class="btn p-0 ml-2" id="kt_header_mobile_topbar_toggle">
					<span class="svg-icon svg-icon-xl">
						<!--begin::Svg Icon | path:<?php echo base_url() ?>assets/frontend/media/svg/icons/General/User.svg-->
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							...
							<div class="container">
								...
								<div class="d-none d-lg-flex align-items-center mr-3">
									...
									<div class="header-switcher">
										<a href="<?php echo base_url('dashboard') ?>" class="btn btn-hover-primary font-weight-bold font-size-sm px-6 border-0" data-offset="0px,1px" >Dashboard Utama</a>
									</div>
									<!--end::Dropdown-->
                                    <?php } ?>
								</div>
								...
								<div class="card card-custom overflow-hidden position-relative mb-8">
									...
									<div class="position-absolute bottom-0 left-0 right-0 d-none d-lg-flex flex-row-fluid">
										<span class="svg-icon svg-icon-full flex-row-fluid svg-icon-dark opacity-3">
											<!--begin::Svg Icon | path:<?php echo base_url() ?>assets/frontend/media/bg/home-2-bg.svg-->
									...
									<div class="position-absolute d-flex top-0 right-0 offset-lg-5 col-lg-7 opacity-30 opacity-lg-100">
										<span class="svg-icon svg-icon-full flex-row-fluid p-15">
											<!--begin::Svg Icon | path:<?php echo base_url() ?>assets/frontend/media/svg/illustrations/working.svg-->
											...
											<div class="input-group shadow-sm">
												...
												<div class="input-group-prepend">
													<span class="input-group-text bg-white border-0 py-7 px-8">
														<span class="svg-icon svg-icon-xl">
															<!--begin::Svg Icon | path:<?php echo base_url() ?>assets/frontend/media/svg/icons/General/Search.svg-->
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																	<rect x="0" y="0" width="24" height="24" />
									...
									<div class="position-relative px-20">
										<ul class="nav nav-tabs nav-tabs-line" role="tablist">
											...
											<li class="nav-item mr-14 mt-4">
												<a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0" href="<?php echo base_url() ?>">Penelitian</a>
											</li>
											<!--end::Nav Item-->
											<!--begin::Nav Item-->
											<li class="nav-item mr-14 mt-4">
												<a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0" href="<?php echo base_url('main/metodologi') ?>">Metodologi</a>
											</li>
											<!--end::Nav Item-->
											<!--begin::Nav Item-->
											<li class="nav-item mr-14 mt-4">
												<a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0" href="<?php echo base_url('main/artikel') ?>">Artikel</a>
											</li>
											<!--end::Nav Item-->
											<!--begin::Nav Item-->
											<li class="nav-item mr-14 mt-4">
											...
											<!--begin::Nav Item-->
											<li class="nav-item mr-14 mt-4">
												<a class="nav-link font-size-h5 font-weight-bold border-2 pb-6 mx-0" href="<?php echo base_url('main/faq') ?>">FAQ</a>
											</li>
											<!--end::Nav Item-->
										</ul>
									</div>
