					...
					<div class="d-flex align-items-center p-5">
						...
						<div class="mr-6">
							<span class="svg-icon svg-icon-primary svg-icon-4x">
								<!--begin::Svg Icon | path:/metronic/theme/html/demo12/dist/assets/media/svg/icons/Home/Mirror.svg-->
						...
						<div class="d-flex flex-column">
							...
							<div class="text-dark-75">Model dengan Crawling dan Scraping</div>
						</div>
						<!--end::Content-->
					</div>
				</div>
					...
					<div class="d-flex align-items-center p-5">
						...
						<div class="mr-6">
							<span class="svg-icon svg-icon-danger svg-icon-4x">
								<!--begin::Svg Icon | path:/metronic/theme/html/demo12/dist/assets/media/svg/icons/General/Thunder-move.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
									width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24" />
						...
						<div class="d-flex flex-column">
							<a href="#"
								class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">Text Mining</a>
							<div class="text-dark-75">Klasifikasi Multinomial Naive Bayes</div>
						</div>
						<!--end::Content-->
					</div>
				</div>
					...
					<div class="d-flex align-items-center p-5">
						...
						<div class="mr-6">
							<span class="svg-icon svg-icon-success svg-icon-4x">
								<!--begin::Svg Icon | path:/metronic/theme/html/demo12/dist/assets/media/svg/icons/Design/Sketch.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
									width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24" />
						...
						<!--begin::Content-->
						<div class="d-flex flex-column">
							<a href="#" class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">Komputasi</a>
							<div class="text-dark-75">Perhitungan sistematis dengan teknologi Python</div>
						</div>
						<!--end::Content-->
					</div>
				</div>
	...
	<div class="col-md-12 mb-8">
		<div class="card card-body">
			<div class="p-6">
				...
				<p>Bagaimana cara kerja deteksi otomatis dengan perhitungan Multinomial Naive Bayes ?</p>
				<div class="text-center">
					<img src="<?php echo base_url('assets/media/path.png') ?>" style="width: 750px">
                    <small></small>
				</div>
			</div>
		</div>
...
<div class="row">
	<div class="col-lg-6">
		<div class="card mb-8">
			<div class="card-body">
				<div class="p-6">
					<h2 class="text-dark mb-8">Latar Belakang</h2>
					<!--begin::Accordion-->
						...
						<div class="card">
							...
							<div class="card-header" id="headingOne7">
								<div class="card-title" data-toggle="collapse" data-target="#collapseOne7"
									...
									<div class="card-label text-dark pl-4">Masalah</div>
								</div>
							</div>
							<!--end::Header-->
							<!--begin::Body-->
						...
						<div class="card">
							...
							<div class="card-header" id="headingTwo7">
								<div class="card-title collapsed" data-toggle="collapse" data-target="#collapseTwo7"
									...
									<div class="card-label text-dark pl-4">Akibat ?</div>
								</div>
							</div>
							<!--end::Header-->
							<!--begin::Body-->
						...
						<div class="card">
							...
							<div class="card-header" id="headingThree7">
								<div class="card-title collapsed" data-toggle="collapse" data-target="#collapseThree7"
									...
									<div class="card-label text-dark pl-4">Solusi</div>
								</div>
							</div>
							<!--end::Header-->
							<!--begin::Body-->
	...
	<div class="col-lg-6">
		<div class="card mb-8">
			<div class="card-body">
				<div class="p-6">
					<h2 class="text-dark mb-8">Istilah dan Algoritma</h2>
					<!--begin::Accordion-->
					<div class="accordion accordion-light accordion-light-borderless accordion-svg-toggle"
						...
						<div class="card">
							...
							<div class="card-header" id="headingOne8">
								<div class="card-title" data-toggle="collapse" data-target="#collapseOne8"
									aria-expanded="true" aria-controls="collapseOne8" role="button">
									<span class="svg-icon svg-icon-primary">
										<!--begin::Svg Icon | path:/metronic/theme/html/demo12/dist/assets/media/svg/icons/Navigation/Angle-double-right.svg-->
										<svg xmlns="http://www.w3.org/2000/svg"
											xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
									...
									<div class="card-label text-dark pl-4">Crawling ?</div>
								</div>
							</div>
							<!--end::Header-->
							<!--begin::Body-->
						...
						<div class="card">
							...
							<div class="card-header" id="headingTwo8">
								<div class="card-title collapsed" data-toggle="collapse" data-target="#collapseTwo8"
									aria-expanded="true" aria-controls="collapseTwo8" role="button">
									<span class="svg-icon svg-icon-primary">
										<!--begin::Svg Icon | path:/metronic/theme/html/demo12/dist/assets/media/svg/icons/Navigation/Angle-double-right.svg-->
										<svg xmlns="http://www.w3.org/2000/svg"
											xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
									...
									<div class="card-label text-dark pl-4">Scraping ?</div>
								</div>
							</div>
							<!--end::Header-->
							<!--begin::Body-->
						...
						<div class="card">
							...
							<div class="card-header" id="headingThree8">
								<div class="card-title collapsed" data-toggle="collapse" data-target="#collapseThree8"
									aria-expanded="true" aria-controls="collapseThree8" role="button">
									<span class="svg-icon svg-icon-primary">
										<!--begin::Svg Icon | path:/metronic/theme/html/demo12/dist/assets/media/svg/icons/Navigation/Angle-double-right.svg-->
										<svg xmlns="http://www.w3.org/2000/svg"
											xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
