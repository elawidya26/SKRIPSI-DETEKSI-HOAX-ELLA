                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-8">
                                                                <div class="form-group">
                                                                    <input type="text" name="text" class="form-control" placeholder="Uji coba text . . ." />
                                                                    <small>Lakukan pengujian untuk melihat hasil</small>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <button class="btn btn-light-primary">Pengujian</button>
                                                            </div>
                                                        </div>
