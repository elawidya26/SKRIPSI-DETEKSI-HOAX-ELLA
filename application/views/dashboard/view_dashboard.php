<div class="content flex-column-fluid" id="kt_content">
								...
								<div class="card">
									...
									<div class="card-body position-relative">
										<h2 class="7 text-white text-center my-10 my-lg-15">DETEKSI KONTEN HOAX VAKSIN COVID-19 DI MEDIA SOSIAL</h2>
										<!-- begin: Tabs-->
										<div class="d-flex justify-content-center">
											<ul class="nav nav-pills nav-primary mb-10 mb-lg-20 bg-white rounded" id="pills-tab" role="tablist">
												<li class="nav-item p-0 m-0">
													<a class="nav-link active font-weight-bolder rounded-right-0 px-8 py-5" id="pills-tab-1" data-toggle="pill" href="#kt-pricing-2_content1" aria-expanded="true" aria-controls="kt-pricing-2_content1">HOAX</a>
												</li>
												<li class="nav-item p-0 m-0">
													<a class="nav-link font-weight-bolder rounded-left-0 px-8 py-5" id="pills-tab-2" data-toggle="pill" href="#kt-pricing-2_content2" aria-expanded="true" aria-controls="kt-pricing-2_content2">NON-HOAX</a>
												</li>
											</ul>
										</div>
										<!-- end: Tabs-->
															...
															<div class="pt-30 pt-md-25 pb-15 px-5 text-center">
																...
																<div class="d-flex flex-center position-relative mb-25">
																	...
																	<span class="svg-icon svg-icon-5x svg-icon-primary">
																		<!--begin::Svg Icon | path:/metronic/theme/html/demo8/dist/assets/media/svg/icons/Home/Flower3.svg-->
														...
														<div class="col-md-4">
															<div class="pt-30 pt-md-25 pb-15 px-5 text-center">
																...
																<div class="d-flex flex-center position-relative mb-25">
																	...
																	<span class="svg-icon svg-icon-5x svg-icon-primary">
																		<!--begin::Svg Icon | path:/metronic/theme/html/demo8/dist/assets/media/svg/icons/Shopping/Cart2.svg-->
																		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																				<rect x="0" y="0" width="24" height="24" />
