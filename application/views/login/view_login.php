				...
				<div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(<?php echo base_url() ?>assets/media/bg/bg-1.jpg);">
					<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
						...
						<div class="d-flex flex-center mb-15">
							<a href="#">
								<img src="<?php echo base_url() ?>assets/media/logos/logo-letter-9.png" class="max-h-100px" alt="" />
							</a>
						</div>
						<!--end::Login Header-->
						...
						<div class="login-signin">
							...
							<form class="form" id="kt_login_signin_form">
								...
								<div class="form-group text-center mt-10">
									<a href="<?php echo base_url('dashboard/index') ?>" class="btn btn-pill btn-outline-white font-weight-bold opacity-90 px-15 py-3">Sign In</a>
								</div>
							</form>
							<div class="mt-10">
